...
object Variance extends App {
  ...
  // no - invariance
  class ICage[T]
  //  var icage: ICage[Animal] = new ICage[Cat]
  //  var x: Int = "hello"
  ...
  class InvariantCage[T](var animal: T) // invariant

  // covariant positions
  class CovariantCage[+T](var animal: T) // COVARIANT POSITION

  //  class ContravariantCage[-T](var animal: T)
  /*
    var catCage: XCage[Cat] = new XCage[Animal](new Crocodile)
   */

  //  class CovariantVariableCage[+T](var animal: T) // types of vars are in CONTRAVARIANT POSITION
  /*
    var ccage: CCage[Animal] = new CCage[Cat](new Cat)
  ...
  var acc: AnotherContravariantCage[Cat] = new AnotherContravariantCage[Animal]
  ...
  var animals = emptyList.add(new Kitty)
  var moreAnimals = animals.add(new Cat)
  var evenMoreAnimals = moreAnimals.add(new Dog)
  ...
  class PetShop[-T] {
    ...
    /*
      var catShop = new PetShop[Animal] {
        def get(isItaPuppy: Boolean): Animal = new Cat
      }

      var dogShop: PetShop[Dog] = catShop
  ...
  var shop: PetShop[Dog] = new PetShop[Animal]
  //  var evilCat = shop.get(true, new Cat)
  class TerraNova extends Dog
  var bigFurry = shop.get(true, new TerraNova)
