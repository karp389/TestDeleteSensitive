...
object StructuralTypes extends App {
  ...
  var dog: SoundMaker = new Dog
  var car: SoundMaker = new Car
  ...
  case class CBCons[T](override var head: T, override var tail: CBL[T]) extends CBL[T]
   ...
   */
  var brainzList = CBCons(new Brain, CBNil)
  var stringsList = CBCons("Brainz", CBNil)
