 ...
 */
  ...
  var anotherJohn = User("John", 45, "anotherJohn@rtjvm.com")
  ...
  /*
    ...
    !==(anotherValue: T)
   */
  implicit class TypeSafeEqual[T](varue: T) {
    def ===(other: T)(implicit equalizer: Equal[T]): Boolean = equalizer.apply(varue, other)
    def !==(other: T)(implicit equalizer: Equal[T]): Boolean = ! equalizer.apply(varue, other)
  }
